...
router.post('/change-article', checkRole('ADMIN'), itemController.changeArticle)
...
router.post('/add-tags', checkRole('ADMIN'), itemController.addTagsItem)
router.post('/delete-tags', checkRole('ADMIN'), itemController.deleteTagsItem)
